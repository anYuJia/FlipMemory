...
<template>
  <div class="page-container">
    ...
    <div class="relative max-w-lg mx-auto px-6">
      <header class="pt-16 pb-8 safe-area-top transition-all duration-700" :style="{ opacity: isLoaded ? 1 : 0 }">
        <div class="flex flex-col gap-1">
          <div class="flex items-center gap-2">
            <span class="text-[10px] font-black tracking-[0.3em] uppercase opacity-40" style="color: var(--text-tertiary);">Preferences</span>
            <div class="w-1 h-1 rounded-full bg-orange-400 opacity-60"></div>
          </div>
          <h1 class="text-4xl font-black tracking-tighter" style="color: var(--text-primary);">应用设置</h1>
        </div>
      </header>
      
      <!-- 名片 -->
      <section class="mb-10 transition-all duration-700 delay-100" :style="{ opacity: isLoaded ? 1 : 0 }">
        <button @click="goToProfileSettings" class="w-full relative overflow-hidden p-6 rounded-[2.5rem] card-static shadow-xl transition-all duration-500 hover:scale-[1.02] active:scale-95 group">
          ...
          <div class="relative flex items-center gap-5">
            ...
            <div class="flex-1 text-left">
              ...
              <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/5 dark:bg-white/5 mt-3">
                <span class="text-[9px] font-black uppercase tracking-wider opacity-40" style="color: var(--text-primary);">Edit Profile</span>
                <ChevronRight class="w-3 h-3 opacity-20" style="color: var(--text-primary);" />
              </div>
            </div>
          </div>
        </button>
      ...
      <!-- 分组 1 -->
      <section class="mb-8">
        <span class="text-[10px] font-black tracking-[0.2em] uppercase opacity-30 px-2 mb-3 block" style="color: var(--text-primary);">Appearance</span>
        <div class="rounded-[2.5rem] overflow-hidden card-static shadow-sm">
          <button @click="goToThemeSettings" class="w-full flex items-center gap-4 px-6 py-5 hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
            ...
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold opacity-30" style="color: var(--text-primary);">{{ themeLabel[userStore.theme] }}</span>
          ...
          <div class="flex items-center gap-4 px-6 py-5">
            ...
            <div class="flex-1">
              ...
              <div class="text-[10px] font-medium opacity-30 uppercase tracking-wider mt-0.5" style="color: var(--text-primary);">21:00 Daily</div>
            </div>
      ...
      <!-- 分组 2 -->
      <section class="mb-8">
        <span class="text-[10px] font-black tracking-[0.2em] uppercase opacity-30 px-2 mb-3 block" style="color: var(--text-primary);">Security</span>
        <div class="rounded-[2.5rem] overflow-hidden card-static shadow-sm">
          ...
          <div class="flex items-center gap-4 px-6 py-5">
            ...
            <div class="flex-1 text-left">
              ...
              <div class="text-[10px] font-medium opacity-30 uppercase tracking-wider mt-0.5" style="color: var(--text-primary);">{{ totalPendingCount > 0 ? syncStatusText : 'Synced' }}</div>
            </div>
          ...
          <div class="flex items-center gap-4 px-6 py-5">
            ...
            <div class="flex-1 text-left">
              ...
              <div class="text-[10px] font-medium opacity-30 uppercase tracking-wider mt-0.5" style="color: var(--text-primary);">{{ cacheStats?.storageUsage || '...' }} Used</div>
            </div>
